...
export const INITIAL_ITEMS = [
  {
    id: 'item-aloo-paratha',
    titleMr: 'गरमागरम आलू पराठा (ताजे लोणी, दही व लोणचे)',
    titleEn: 'Fresh Aloo Paratha (With White Butter, Curd & Pickle)',
    category: 'snacks',
    price: 90,
    unit: '२ नग (2 Pcs)',
    unitEn: '2 Pcs',
    ...
    descriptionMr: 'उकडलेले बटाटे, हिरवी मिरची, कोथिंबीर व घरगुती मसाल्यांचे सारण भरून बनवलेले २ गरमागरम आलू पराठे. सोबत ताजे पांढरे लोणी, घट्ट दही व लोणचे.',
    descriptionEn: '2 Freshly roasted parathas stuffed with spiced potato filling. Served with fresh white butter, thick curd & pickle.',
    extraAddOns: COMMON_SNACK_ADDONS,
    ingredientsMr: ['२ आलू पराठे', 'ताजे पांढरे लोणी', 'घट्ट दही', 'घरगुती लिंबू लोणचे', 'हिरवी चटणी'],
    ingredientsEn: ['2 Aloo Parathas', 'Fresh White Butter', 'Thick Curd', 'Homemade Pickle', 'Green Chutney']
  },
  {
